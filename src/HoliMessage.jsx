...
function HoliMessage() {
  return (
    <div
      className="relative min-h-screen w-full flex items-center justify-center text-white text-center px-4 sm:px-6 overflow-hidden bg-cover bg-center animated-bg"
      style={{ backgroundImage: `url(${holiBg})` }}
    >
      {/* 🌟 Soft Glow */}
      <div className="absolute w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] bg-pink-500/30 blur-3xl rounded-full"></div>
      ...
      >
        <Sparkles
          className="mx-auto mb-4 sm:mb-6 text-yellow-300 animate-pulse"
          size={40}
        />

        <h1 className="text-3xl sm:text-5xl font-extrabold mb-4 sm:mb-6 tracking-wide 
        ...
        <p className="mt-6 sm:mt-8 text-base sm:text-xl font-semibold 
